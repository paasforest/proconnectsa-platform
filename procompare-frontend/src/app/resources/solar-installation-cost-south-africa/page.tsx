...
const guide = resourceGuides.find((g) => g.slug === 'solar-installation-cost-south-africa')

export const metadata = {
  title: guide?.metaTitle,
  description: guide?.metaDescription,
  alternates: {
    canonical: 'https://www.proconnectsa.co.za/resources/solar-installation-cost-south-africa',
  },
  openGraph: {
    title: guide?.metaTitle,
    description: guide?.metaDescription,
