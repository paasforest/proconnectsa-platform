...
export default function PaintingCostPretoriaPage() {
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Painting Costs in Pretoria (2026 Guide)",
    description: "Complete guide to painting costs, prices per square meter, and room pricing in Pretoria",
    author: {
      "@type": "Organization",
      name: "ProConnectSA",
    },
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://www.proconnectsa.co.za/resources/painting-cost-pretoria",
    },
  }
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <nav className="text-sm text-gray-600 mb-4">
                ...
                <span className="mx-2">/</span>
                <span className="text-gray-900 font-medium">Painting Cost Pretoria</span>
              </nav>
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
                Painting Costs in Pretoria (2026 Guide)
              </h1>
              <p className="text-gray-700 text-lg md:text-xl mb-4">
                Planning a painting project in Pretoria? Average costs range from R25-R60 per square meter for interior walls and R30-R70 for exterior walls. This guide breaks down all painting costs so you can budget accurately.
              </p>
              <p className="text-gray-600 text-base mb-6">
                Whether you need interior painting in <Link href="/pretoria/painting" className="text-emerald-700 hover:text-emerald-800 hover:underline font-medium">Pretoria</Link>, exterior painting, or a complete repaint, understanding painting costs helps you make informed decisions. <Link href="/pretoria/painting" className="text-emerald-700 hover:text-emerald-800 hover:underline font-medium">Get free quotes from verified painters in Pretoria</Link> to compare pricing and find the best rates.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-emerald-50 border-2 border-emerald-200 rounded-2xl p-6 mb-8">
                ...
                <div className="mt-4 pt-4 border-t border-emerald-200">
                  <p className="text-sm text-gray-700 mb-3">
                    <strong>Want to compare actual quotes?</strong> <Link href="/pretoria/painting" className="text-emerald-700 hover:text-emerald-800 hover:underline font-semibold">Get free quotes from verified painters in Pretoria</Link> to see real pricing for your specific project.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-blue-50 border-2 border-emerald-200 rounded-2xl p-8 mb-8">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 text-center">
                  Ready to Get Quotes from Verified Painters in Pretoria?
                </h2>
                <p className="text-gray-700 text-lg mb-6 text-center max-w-2xl mx-auto">
                  Compare quotes from up to 3 verified painters in Pretoria. See real pricing for your project, compare services, and choose the best fit—all free with no obligation to hire.
                </p>
                <div className="text-center">
                  <Link
                    href="/pretoria/painting"
                  ...
                  >
                    Get Free Painting Quotes in Pretoria →
                  </Link>
                </div>
              </div>
            </div>
