...
const guides = [
  ...
  },
  {
    ...
    title: "Plumber Cost South Africa (2026 Prices + Quotes)",
    description: "2026 plumber pricing across South Africa: call-outs, hourly rates, repairs, and geyser work. Compare free quotes from verified plumbers.",
    category: "Cost Guides",
    icon: DollarSign,
  },
  {
  ...
  },
  {
    ...
    title: "House Painting Cost South Africa (2026 Prices + Quotes)",
    description: "2026 house painting costs per m², rooms, and exteriors. Compare free quotes from verified painters.",
    category: "Cost Guides",
    icon: DollarSign,
  },
  {
    slug: "pest-control-cost-south-africa",
    title: "Pest Control Cost South Africa (2026 Prices + Quotes)",
    description: "2026 pest control pricing for insects, rodents, and termites. Compare free quotes from verified specialists.",
    category: "Cost Guides",
    icon: DollarSign,
  },
  {
    slug: "cleaning-services-cost-south-africa",
    title: "Cleaning Services Cost South Africa (2026 Prices + Quotes)",
    description: "2026 cleaning service rates: hourly, per home, deep cleans, and move-outs. Compare free quotes from verified cleaners.",
    category: "Cost Guides",
    icon: DollarSign,
  },
  {
